...
public class BluetoothLeDeviceImpl implements BluetoothLeDevice {
    ...
    public BluetoothLeGattService findService(UUID uuid) throws KuraException {
        ...
        try {
            service = this.device.find(uuid.toString(), BluetoothLeDeviceImpl.TIMEOUT);
        } catch (Exception e) {
            throw new KuraBluetoothResourceNotFoundException(e, "Gatt service not found.");
        }
        if (service != null) {
    ...
    public List<BluetoothLeGattService> findServices() throws KuraException {
        ...
        try {
            ...
            throw new KuraBluetoothResourceNotFoundException(e, "Gatt services not found.");
        }
        return services;
    }
